...
Есть все, live-обновление, экспоненциальная деградация, таблица и дерево, AI-поиск, но он привязан к ANTHROPIC_API_KEY
...
В код залазить не приходилось, так как тестовое и этот спам комментариями здесь не критичен. Он прям перебирает с деталями, которые и так понятны из кода.
